...
<head>
    ...
    <title> Job Seeker Dash Board</title>
...
<!-- Icon Cards-->
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card text-white bg-success o-hidden h-100">
                        <div class="card-body">
                            ...
                            <div class="mr-5"> <?php echo JobCountOf($id); ?> New Jobs!</div>
                        </div>
            ...
            <hr>
            <div id="jobs">
                <h5>Jobs and Details for <?php echo $this->session->userdata('LoggedInUserName'); ?> </h5>
                <br>
            <div class="row" >
                <?php 

                    
                    $data = JobDatasForJobSeeker($id);
                    // testArray($data);
                    
                    foreach ($data as $index => $singlerow ) {
                        // print($index);
                        // testArray($singlerow);
                        $this->load->view('jobsofjobseeker',$singlerow);
                    }
